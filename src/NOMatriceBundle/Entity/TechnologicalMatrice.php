...
/**
 * TechnologicalMatrice
 *
 * @ORM\Table(name="technological_matrice")
 * @ORM\Entity(repositoryClass="NOMatriceBundle\Repository\TechnologicalMatriceRepository")
 */
class TechnologicalMatrice
{
    /**
     * @var int
     *
